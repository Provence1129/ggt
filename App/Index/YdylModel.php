...
class YdylModel {
    ...
    {
        // 获取资讯详情
        $sql        = 'SELECT yy_id,ys_id,yt_id,au_id,yy_title,yy_description,yy_hits,yy_heart,yy_order FROM '.$this -> Db -> getTableNameAll('ydyl').' WHERE '.$whereString;
    ...
    public function del(array $whereArray = [])
    {
        ...
        // 条件处理
        $whereString    = 'au_id='.$this->userid.' AND yy_isdel='.static::ISDEL;
